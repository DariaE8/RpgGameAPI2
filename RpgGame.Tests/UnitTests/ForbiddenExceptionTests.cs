...
public class ForbiddenExceptionTests
{
    ...
    {
        // Arrange & Act
        var exception = new RpgGame.Core.Exceptions.ForbiddenException("Access denied");
    ...
    {
        // Arrange & Act
        var exception = new RpgGame.Core.Exceptions.ForbiddenException("");
    ...
    public void Constructor_ShouldHandleNullMessage_ByProvidingDefault()
    {
        ...
        var exception = new RpgGame.Core.Exceptions.ForbiddenException(null!);
    ...
    {
        // Act & Assert
        Action act = () => throw new RpgGame.Core.Exceptions.ForbiddenException("Error");
        
        act.Should().Throw<RpgGame.Core.Exceptions.ForbiddenException>()
            .WithMessage("Error");
    }
    ...
    {
        // Arrange & Act
        var exception = new RpgGame.Core.Exceptions.ForbiddenException("Test");

        // Assert
        exception.Should().BeOfType<RpgGame.Core.Exceptions.ForbiddenException>();
    }
    ...
    {
        // Arrange & Act
        var exception = new RpgGame.Core.Exceptions.ForbiddenException(message);
    ...
    public void ShouldWorkWithTryCatch()
    {
        ...
        try
        {
            throw new RpgGame.Core.Exceptions.ForbiddenException("Test message");
        }
        catch (RpgGame.Core.Exceptions.ForbiddenException ex)
        {
            wasCaught = true;
    ...
    public void ToString_ShouldContainExceptionInfo()
    {
        ...
        // Assert
        result.Should().Contain("ForbiddenException");
